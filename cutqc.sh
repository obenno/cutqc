...
Rscript -e 'rmarkdown::render("fastqc_report.Rmd", params=list(read1_before_dir = "'$read1_before_dir'", read1_after_dir="'$read1_after_dir'", read2_before_dir = "'$read2_before_dir'", read2_after_dir = "'$read2_after_dir'", cutadapt_cmd = "'$cutadapt_cmd'"), knit_root_dir=getwd(), output_file="'$outHtml'")'
